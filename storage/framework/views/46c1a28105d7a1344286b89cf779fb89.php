<?php # [BlazeFolded]:{flux::toast}:{C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/flux/toast/index.blade.php}:{1782477722} ?>
<?php # [BlazeFolded]:{flux::toast.group}:{C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/flux/toast/group.blade.php}:{1782477722} ?>
<!DOCTYPE html>
        ...
        <div class="relative z-10 flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:p-10">
            <div class="flex w-full max-w-sm flex-col gap-6">
                ...
                <a href="<?php echo e(route('home')); ?>" class="flex flex-col items-center gap-2 font-medium" wire:navigate>
                    <img src="<?php echo e(asset('images/pathwise-logo-full.png')); ?>" alt="PATHWISE" class="h-12 w-auto" />
                    <span class="sr-only"><?php echo e(config('app.name', 'PATHWISE')); ?></span>
                </a>
...
</html><?php /**PATH C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/layouts/auth/simple.blade.php ENDPATH**/ ?>