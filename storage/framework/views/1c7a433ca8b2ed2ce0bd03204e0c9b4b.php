<?php # [BlazeFolded]:{flux::link}:{C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/flux/link.blade.php}:{1782477712} ?>
<?php # [BlazeFolded]:{flux::button}:{C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/flux/button/index.blade.php}:{1782477712} ?>
<?php # [BlazeFolded]:{flux::link}:{C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/flux/link.blade.php}:{1782477712} ?>
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('login.store')); ?>" class="flex flex-col gap-6">
            ...
            <!-- Email Address -->
            <?php $__blaze->ensureRequired('C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/flux/input/index.blade.php', $__blaze->compiledPath.'/f1ab8d5836a8193ea495a88e4fd9acf4.php'); ?>
...
<?php _f1ab8d5836a8193ea495a88e4fd9acf4($__blaze, ['name' => 'email','label' => __('Email address'),'value' => old('email'),'type' => 'email','required' => true,'autofocus' => true,'autocomplete' => 'email','placeholder' => 'email@example.com'], [], ['label', 'value', 'required', 'autofocus'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php _f1ab8d5836a8193ea495a88e4fd9acf4($__blaze, ['name' => 'password','label' => __('Password'),'type' => 'password','required' => true,'autocomplete' => 'current-password','placeholder' => __('Password'),'viewable' => true], [], ['label', 'required', 'placeholder', 'viewable'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            ...
            <!-- Remember Me -->
            <?php $__blaze->ensureRequired('C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/flux/checkbox/index.blade.php', $__blaze->compiledPath.'/aaa7973a9f7363cd715f00e94184c0cb.php'); ?>
<?php $__blaze->pushData(['name' => 'remember','label' => __('Remember me'),'checked' => old('remember')]); ?>
<?php _aaa7973a9f7363cd715f00e94184c0cb($__blaze, ['name' => 'remember','label' => __('Remember me'),'checked' => old('remember')], [], ['label', 'checked'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/pages/auth/login.blade.php ENDPATH**/ ?>