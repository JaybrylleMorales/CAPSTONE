<?php
if (!function_exists('_031c12bf110c46935a96cd659ba9bf1f')):
function _031c12bf110c46935a96cd659ba9bf1f($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
    ...
    ->add(match ($variant) {
        'outline' => match ($accent) {
            true => [
                ...
                'data-current:bg-purple-500/10 dark:data-current:bg-purple-500/15 data-current:border data-current:border-purple-500/40 dark:data-current:border-purple-500/30 data-current:shadow-[inset_3px_0_0_var(--color-purple-500)]',
        ...
        default => match ($accent) {
            true => [
                'data-current:text-zinc-900 dark:data-current:text-white hover:data-current:text-zinc-900 dark:hover:data-current:text-white',
                'data-current:bg-purple-500/10 dark:data-current:bg-purple-500/15 data-current:shadow-[inset_3px_0_0_var(--color-purple-500)]',
...
} endif; ?><?php /**PATH C:\Users\admin\pathwise\resources\views/flux/navlist/item.blade.php ENDPATH**/ ?>