<?php # [BlazeFolded]:{flux::label}:{C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/flux/label.blade.php}:{1782477712} ?>
<?php # [BlazeFolded]:{flux::description}:{C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/flux/description.blade.php}:{1782477712} ?>
<?php # [BlazeFolded]:{flux::field}:{C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/flux/field.blade.php}:{1782477712} ?>
<?php
if (!function_exists('_23af5e47a5b9685b3cf9b89d0eaa0321')):
function _23af5e47a5b9685b3cf9b89d0eaa0321($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php _e0ebcac5a789e8c0f52d17639f8156c8($__blaze, ['name' => $scope['name']], [], ['name'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH C:\Users\NIKKA D. BERDIN\Herd\pathwise\vendor\livewire\flux\src/../stubs/resources/views/flux/with-inline-field.blade.php ENDPATH**/ ?>