<?php
if (!function_exists('__7643c10f5025c4f14911364bf5c4fbfc')):
function __7643c10f5025c4f14911364bf5c4fbfc($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<div <?php echo e($attributes->class($classes)); ?> data-flux-checkbox-indicator>
    <?php $__blaze->ensureRequired('C:\Users\admin\pathwise\resources\views/flux/icon/check.blade.php', $__blaze->compiledPath.'/1ba880daef2479d4ff39f26fe9aab54b.php'); ?>
<?php $__blaze->pushData(['variant' => 'micro','class' => 'hidden text-[var(--color-accent-foreground)]']); ?>
<?php __1ba880daef2479d4ff39f26fe9aab54b($__blaze, ['variant' => 'micro','class' => 'hidden text-[var(--color-accent-foreground)]'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
    <?php $__blaze->ensureRequired('C:\Users\admin\pathwise\resources\views/flux/icon/minus.blade.php', $__blaze->compiledPath.'/40cdcf8f4f3cd71d7c1d9c6d019c801c.php'); ?>
<?php $__blaze->pushData(['variant' => 'micro','class' => 'hidden text-[var(--color-accent-foreground)]']); ?>
<?php __40cdcf8f4f3cd71d7c1d9c6d019c801c($__blaze, ['variant' => 'micro','class' => 'hidden text-[var(--color-accent-foreground)]'], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
</div>
<?php
echo $__blaze->processPassthroughContent('ltrim', ltrim(ob_get_clean()));
} endif; ?><?php /**PATH C:\Users\admin\pathwise\resources\views/flux/checkbox/indicator.blade.php ENDPATH**/ ?>