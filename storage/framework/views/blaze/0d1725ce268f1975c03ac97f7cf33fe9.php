<?php
if (!function_exists('__0d1725ce268f1975c03ac97f7cf33fe9')):
function __0d1725ce268f1975c03ac97f7cf33fe9($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($collapsibleOnMobile): ?>
    <?php $__blaze->ensureRequired('C:\Users\admin\pathwise\resources\views/flux/sidebar/backdrop.blade.php', $__blaze->compiledPath.'/a96c1d28be2a35e876bccc390e2daea3.php'); ?>
<?php $__blaze->pushData([]); ?>
<?php __a96c1d28be2a35e876bccc390e2daea3($__blaze, [], [], [], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
} endif; ?><?php /**PATH C:\Users\admin\pathwise\resources\views/flux/sidebar/index.blade.php ENDPATH**/ ?>