<?php
if (!function_exists('__da8aa07eaba3305aa9e4b42877c7ed11')):
function __da8aa07eaba3305aa9e4b42877c7ed11($__blaze, $__data = [], $__slots = [], $__bound = [], $__keys = [], $__this = null) {
$__env = $__blaze->env;
...
<?php $__blaze->ensureRequired('C:\Users\NIKKA D. BERDIN\Herd\pathwise\vendor\livewire\flux\src/../stubs/resources/views/flux/with-tooltip.blade.php', $__blaze->compiledPath.'/70fcc9ba3e3907ecc18e377b76043983.php'); ?>
<?php if (isset($__slots70fcc9ba3e3907ecc18e377b76043983)) { $__slotsStack70fcc9ba3e3907ecc18e377b76043983[] = $__slots70fcc9ba3e3907ecc18e377b76043983; } ?>
<?php if (isset($__attrs70fcc9ba3e3907ecc18e377b76043983)) { $__attrsStack70fcc9ba3e3907ecc18e377b76043983[] = $__attrs70fcc9ba3e3907ecc18e377b76043983; } ?>
<?php $__attrs70fcc9ba3e3907ecc18e377b76043983 = ['attributes' => $attributes]; ?>
<?php $__slots70fcc9ba3e3907ecc18e377b76043983 = []; ?>
<?php $__blaze->pushData($__attrs70fcc9ba3e3907ecc18e377b76043983); ?>
<?php ob_start(); ?>
    <?php $__blaze->ensureRequired('C:\Users\NIKKA D. BERDIN\Herd\pathwise\vendor\livewire\flux\src/../stubs/resources/views/flux/button-or-link-pure.blade.php', $__blaze->compiledPath.'/c1dd92e50e045a1917fdaf8395251964.php'); ?>
<?php if (isset($__slotsc1dd92e50e045a1917fdaf8395251964)) { $__slotsStackc1dd92e50e045a1917fdaf8395251964[] = $__slotsc1dd92e50e045a1917fdaf8395251964; } ?>
<?php if (isset($__attrsc1dd92e50e045a1917fdaf8395251964)) { $__attrsStackc1dd92e50e045a1917fdaf8395251964[] = $__attrsc1dd92e50e045a1917fdaf8395251964; } ?>
<?php $__attrsc1dd92e50e045a1917fdaf8395251964 = ['type' => $type,'attributes' => $attributes->class($classes),'dataFluxButton' => true]; ?>
<?php $__slotsc1dd92e50e045a1917fdaf8395251964 = []; ?>
<?php $__blaze->pushData($__attrsc1dd92e50e045a1917fdaf8395251964); ?>
<?php ob_start(); ?>
        <?php if ($loading): ?>
            <div class="absolute inset-0 flex items-center justify-center opacity-0" data-flux-loading-indicator>
                <?php $__blaze->ensureRequired('C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/flux/icon/index.blade.php', $__blaze->compiledPath.'/6b99188e183fc15248fb492af0b793fc.php'); ?>
<?php $__blaze->pushData(['icon' => 'loading','variant' => $iconVariant,'class' => $iconClasses]); ?>
<?php __6b99188e183fc15248fb492af0b793fc($__blaze, ['icon' => 'loading','variant' => $iconVariant,'class' => $iconClasses], [], ['variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
            </div>
        <?php endif; ?>
...
<?php __6b99188e183fc15248fb492af0b793fc($__blaze, ['icon' => $iconLeading,'variant' => $iconVariant,'class' => $iconClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
...
<?php __6b99188e183fc15248fb492af0b793fc($__blaze, ['icon' => $iconTrailing,'variant' => $iconTrailingVariant,'class' => $iconTrailingClasses], [], ['icon', 'variant', 'class'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php $__blaze->popData(); ?>
        <?php elseif ($iconTrailing): ?>
            <?php echo e($iconTrailing); ?>

        <?php endif; ?>
    <?php $__slotsc1dd92e50e045a1917fdaf8395251964['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slotsc1dd92e50e045a1917fdaf8395251964); ?>
<?php __c1dd92e50e045a1917fdaf8395251964($__blaze, $__attrsc1dd92e50e045a1917fdaf8395251964, $__slotsc1dd92e50e045a1917fdaf8395251964, ['type', 'attributes', 'dataFluxButton'], ['dataFluxButton' => 'data-flux-button'], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStackc1dd92e50e045a1917fdaf8395251964)) { $__slotsc1dd92e50e045a1917fdaf8395251964 = array_pop($__slotsStackc1dd92e50e045a1917fdaf8395251964); } ?>
<?php if (! empty($__attrsStackc1dd92e50e045a1917fdaf8395251964)) { $__attrsc1dd92e50e045a1917fdaf8395251964 = array_pop($__attrsStackc1dd92e50e045a1917fdaf8395251964); } ?>
<?php $__blaze->popData(); ?>
<?php $__slots70fcc9ba3e3907ecc18e377b76043983['slot'] = new \Illuminate\View\ComponentSlot($__blaze->processPassthroughContent('trim', trim(ob_get_clean())), []); ?>
<?php $__blaze->pushSlots($__slots70fcc9ba3e3907ecc18e377b76043983); ?>
<?php __70fcc9ba3e3907ecc18e377b76043983($__blaze, $__attrs70fcc9ba3e3907ecc18e377b76043983, $__slots70fcc9ba3e3907ecc18e377b76043983, ['attributes'], [], $__this ?? (isset($this) ? $this : null)); ?>
<?php if (! empty($__slotsStack70fcc9ba3e3907ecc18e377b76043983)) { $__slots70fcc9ba3e3907ecc18e377b76043983 = array_pop($__slotsStack70fcc9ba3e3907ecc18e377b76043983); } ?>
<?php if (! empty($__attrsStack70fcc9ba3e3907ecc18e377b76043983)) { $__attrs70fcc9ba3e3907ecc18e377b76043983 = array_pop($__attrsStack70fcc9ba3e3907ecc18e377b76043983); } ?>
<?php $__blaze->popData(); ?>
<?php
echo $__blaze->processPassthroughContent('ltrim', ltrim(ob_get_clean()));
} endif; ?><?php /**PATH C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/flux/button/index.blade.php ENDPATH**/ ?>