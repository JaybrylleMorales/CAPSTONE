...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>" class="dark">
    <head>
        ...
        <title><?php echo e(__('PATHWISE — AI-Powered E-Learning Platform')); ?></title>
        ...
        <div class="relative z-10">
            ...
            <header class="mx-auto flex max-w-6xl items-center justify-between px-6 py-5">
                <div class="flex items-center gap-3">
                    <img src="<?php echo e(asset('images/pathwise-logo-full.png')); ?>" alt="PATHWISE" class="h-14 w-auto" />
                </div>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('login')): ?>
                    <nav class="flex items-center gap-3">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="rounded-lg border border-neutral-700 px-5 py-2 text-sm font-medium transition hover:border-neutral-500 hover:bg-neutral-800">
                                Dashboard
                            </a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="rounded-lg px-5 py-2 text-sm font-medium text-neutral-300 transition hover:text-white">
                                Log in
                            </a>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="rounded-lg bg-gradient-to-r from-purple-500 to-indigo-600 px-5 py-2 text-sm font-semibold text-white shadow-lg transition hover:opacity-90">
                                    Get Started
                                </a>
                ...
                <section class="flex flex-col items-center py-16 text-center lg:py-20">
                    ...
                    <div class="mt-10 flex flex-col gap-3 sm:flex-row">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->guest()): ?>
                            <a href="<?php echo e(route('register')); ?>" class="rounded-xl bg-gradient-to-r from-purple-500 to-indigo-600 px-8 py-3 font-semibold text-white shadow-lg shadow-purple-500/25 transition hover:scale-[1.02] hover:opacity-90">
                                Start Learning Free
                            </a>
                            <a href="<?php echo e(route('login')); ?>" class="rounded-xl border border-neutral-700 px-8 py-3 font-semibold transition hover:border-neutral-500 hover:bg-neutral-800">
                                I already have an account
                            </a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(route('dashboard')); ?>" class="rounded-xl bg-gradient-to-r from-purple-500 to-indigo-600 px-8 py-3 font-semibold text-white shadow-lg shadow-purple-500/25 transition hover:scale-[1.02] hover:opacity-90">
                                Go to Dashboard
                            </a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                ...
                <section class="grid gap-6 pb-24 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <div class="group rounded-2xl border border-neutral-800 bg-neutral-900/50 p-6 transition duration-200 hover:-translate-y-1 hover:border-purple-500/40 hover:bg-neutral-900 hover:shadow-lg hover:shadow-purple-500/10">
                            <div class="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br <?php echo e($colorMap[$f['color']]); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($f['icon']); ?>" />
                                </svg>
                            </div>
                            <h3 class="mb-2 font-semibold"><?php echo e($f['title']); ?></h3>
                            <p class="text-sm text-neutral-400"><?php echo e($f['desc']); ?></p>
                        </div>
            ...
            <footer class="border-t border-neutral-800">
                <div class="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 px-6 py-8 text-sm text-neutral-500 sm:flex-row">
                    <p>&copy; <?php echo e(date('Y')); ?> PATHWISE. An AI-Powered E-Learning Platform.</p>
                    <p>Built with Laravel & Google Gemini</p>
                </div>
            </footer>
        </div>
    </body>
</html><?php /**PATH C:\Users\NIKKA D. BERDIN\Herd\pathwise\resources\views/welcome.blade.php ENDPATH**/ ?>