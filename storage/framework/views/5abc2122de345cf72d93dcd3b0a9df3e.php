...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'f4ac99e09542ff494432bc959d4fee61::app','data' => ['title' => 'Create Learning Path']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute('Create Learning Path')]); ?>
...
<div class="space-y-6">
    ...
    <div class="rounded-xl border bg-white p-6 shadow-sm dark:bg-neutral-900 dark:border-neutral-700">
        ...
        <form action="<?php echo e(route('learning-paths.store')); ?>"
              method="POST"
              class="space-y-5">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div>
                ...
                <textarea name="description"
                          rows="4"
                          class="w-full rounded border p-2 bg-transparent"><?php echo e(old('description')); ?></textarea>
            </div>
...
<?php endif; ?><?php /**PATH C:\Users\admin\pathwise\resources\views/learning-paths/create.blade.php ENDPATH**/ ?>