        ...
        <div class="grid gap-4 lg:grid-cols-3">
            <div class="rounded-xl border border-neutral-200 bg-white p-5 shadow-sm dark:border-neutral-700 dark:bg-neutral-900">
                ...
                <div class="mt-4 space-y-3">
                    ...
                    <a href="{{ route('course-categories.index') }}" class="block rounded-lg border border-neutral-200 px-4 py-3 text-sm font-medium hover:bg-neutral-100 dark:border-neutral-700 dark:hover:bg-neutral-800">
                        Manage Categories
                    </a>

                    <a href="{{ route('courses.index') }}" class="block rounded-lg border border-neutral-200 px-4 py-3 text-sm font-medium hover:bg-neutral-100 dark:border-neutral-700 dark:hover:bg-neutral-800">
                        Manage Courses
                    </a>

                    <a href="{{ route('lessons.index') }}" class="block rounded-lg border border-neutral-200 px-4 py-3 text-sm font-medium hover:bg-neutral-100 dark:border-neutral-700 dark:hover:bg-neutral-800">
                        Manage Lessons
                    </a>

                    <a href="{{ route('quizzes.index') }}" class="block rounded-lg border border-neutral-200 px-4 py-3 text-sm font-medium hover:bg-neutral-100 dark:border-neutral-700 dark:hover:bg-neutral-800">
                        Manage Quizzes
                    </a>
                </div>
            </div>
