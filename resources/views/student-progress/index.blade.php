<x-layouts::app :title="__('Student Progress')">
    <div class="space-y-6">
        ...
        <div class="grid gap-4 md:grid-cols-4">
            ...
            <div class="rounded-2xl border border-blue-800/40 bg-blue-950 p-5">
                    ...
                    <tbody class="divide-y divide-zinc-800">
                        @forelse($enrollments as $enrollment)
                            ...
                            <tr class="hover:bg-zinc-800">
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-xs text-zinc-400">Learner</p>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div class="h-2 w-40 rounded-full bg-zinc-700">
                                ...
                                <td class="px-6 py-4">
                                    ...
                                    @else
                                        <span class="rounded-full border border-blue-500/30 bg-blue-500/20 px-3 py-1 text-xs font-semibold text-blue-300">
                                            Active
                                        </span>
                                    @endif
                                </td>
