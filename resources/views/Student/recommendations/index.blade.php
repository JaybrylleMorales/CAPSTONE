...
<div class="space-y-6">
    ...
    @forelse($recommendations as $recommendation)
        ...
        <div class="overflow-hidden rounded-2xl border border-purple-500/20 bg-linear-to-br from-purple-900/20 to-neutral-900/80 p-6 backdrop-blur">

            <div class="flex items-start justify-between gap-4">

                <div class="flex items-center gap-3">
                    <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-linear-to-br from-purple-500/25 to-indigo-500/15 text-purple-300">
            ...
            <a href="{{ route('student.course.show', $recommendation->course) }}"
               class="mt-5 inline-flex items-center gap-2 rounded-lg bg-linear-to-r from-purple-500 to-indigo-600 px-5 py-2 text-sm font-semibold text-white transition hover:opacity-90">
                View Course
